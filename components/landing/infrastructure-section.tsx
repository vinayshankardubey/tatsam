...
const regions = [
  { name: "India & SAARC",       nodes: 18, status: "serving daily" },
  { name: "Middle East",         nodes: 7,  status: "serving daily" },
  { name: "Europe & UK",         nodes: 9,  status: "serving daily" },
  { name: "Americas & Oceania",  nodes: 6,  status: "serving daily" },
];
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                ...
                Seekers from 40+ countries trust Tatsam for their kundli and numerology readings — delivered in English and Hindi, timed to your zone.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-8xl lg:text-[10rem] font-display leading-none">40</span>
                <span className="text-2xl text-muted-foreground">countries</span>
              </div>
              <p className="text-muted-foreground max-w-md">
                Charts cast and reports delivered across time zones — every muhurat calculated to your exact place of birth.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-100 ${
              ...
              <span className="text-5xl lg:text-6xl font-display">72hr</span>
              <span className="block text-sm text-muted-foreground mt-2">Report delivery, typical</span>
            </div>

            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}>
              <span className="text-5xl lg:text-6xl font-display">EN&middot;HI</span>
              <span className="block text-sm text-muted-foreground mt-2">Read in your tongue</span>
            </div>
          </div>
        </div>
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                <span className={`w-2 h-2 rounded-full transition-colors ${
                  activeRegion === index ? "bg-[#C9A35A]" : "bg-foreground/20"
                }`} />
